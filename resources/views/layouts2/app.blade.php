...
<!-- Mirrored from caketheme.com/html/mojuri/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 07:07:21 GMT -->
...
<head>
    ...
    <title>@yield('title')-Shambhavi</title>

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="media/favicon.png">
    @yield("style")
    <!-- Dependency Styles -->
    <link rel="stylesheet" href="{{asset('assets/libs/bootstrap/css/bootstrap.min.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('assets/libs/feather-font/css/iconfont.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('assets/libs/icomoon-font/css/icomoon.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('assets/libs/font-awesome/css/font-awesome.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('assets/libs/wpbingofont/css/wpbingofont.css')}}" type="text/css">
    <link rel="stylesheet" href="{{asset('assets/libs/elegant-icons/css/elegant.css')}}" type="text/css">
...
<link href="https://fonts.googleapis.com/css2?family=Chicle&family=Oswald:wght@600;700&display=swap" rel="stylesheet">
...
<body class="page">
                                                ...
                                                <div class="slick-wrap">
                                                    <div class="slick-sliders image-additional" data-dots="true" data-columns4="1" data-columns3="1" data-columns2="1" data-columns1="1" data-columns="1" data-nav="true">
                                                        <div class="img-thumbnail slick-slide">
                                                            <a href="{{asset('assets/media/product/3.jpg')}}" class="image-scroll" title="">
                                                                <img width="900" height="900" src="{{asset('assets/media/product/3.jpg')}}" alt="">
                                                            </a>
                                                        </div>
                                                        <div class="img-thumbnail slick-slide">
                                                            <a href="{{asset('assets/media/product/3-2.jpg')}}" class="image-scroll" title="">
                                                                <img width="900" height="900" src="{{asset('assets/media/product/3-2.jpg')}}" alt="">
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <script src="{{asset('assets/libs/slick/js/slick.min.js')}}"></script>
    <script src="{{asset('assets/libs/mmenu/js/jquery.mmenu.all.min.js')}}"></script>
...
<!-- Mirrored from caketheme.com/html/mojuri/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Oct 2023 07:07:49 GMT -->
