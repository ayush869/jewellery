                ...
                <div class="row">
                    <div class="section-column left">
                        <div class="intro-wrap">
                            <h2 class="intro-title">{{ __('messages.Handcrafted') }}<br> &amp; {{ __('messages.Ethically Sourced') }}</h2>
                            <div class="intro-item">
                                ...
                                <div class="content">
                                    <h3 class="title">{{ __('messages.FAIR PRICING') }}</h3>
                            ...
                            <div class="intro-item">
                                ...
                                <div class="content">
                                    <h3 class="title">{{ __('messages.HIGH QUALITY') }}</h3>
                                    <div class="text">{{ __('messages.Nullam quis ante. Pellentesque libero tortor, tincidunt et, tinciduntamet est.In hac habitasse platea dictumst. Praesent nec nisl a purus blandit viverra') }}</div>
                                </div>
                            </div>
                    ...
                    <div class="section-column right">
                        <a href="#">
                            <img class="hover-opacity" width="820" height="674" src="{{asset('assets/media/banner/intro-1.jpg')}}" alt="intro">
                        </a>
                    </div>
                </div>
            </div>
